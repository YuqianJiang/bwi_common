...
-ingdc(P,I) :- { not -inroom(P,R,I) : canbeinroom(P,R) }0, person(P), I>0, I=n-1.

%inroom is inertial unless we want to check on the person again
inroom(P,R,I) :- inroom(P,R,I-1), not -inroom(P,R,I), not findPersonTask(P,I), I>0, I=n-1.
-inroom(P,R,I) :- -inroom(P,R,I-1), not inroom(P,R,I), not findPersonTask(P,I), I>0, I=n-1.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%commenting out the action askperson because it bothers people too much
...
:- remind(P,M,R,I), {meeting(M,G,R) : ingroup(P,G)}0.
...
%findPersonTask(P,I) :- findPersonTask(P,I-1), not ingdc(P,I), not -ingdc(P,I), I>0, I=n-1.

findPersonTask(P,I) :- findPersonTask(P,I).
